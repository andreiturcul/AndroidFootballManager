  ...
  public UserDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfUser = new EntityInsertionAdapter<User>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR ABORT INTO `users` (`id`,`name`,`email`,`passwordHash`,`userTeamId`,`favouritePlayerTeamId`) VALUES (nullif(?, 0),?,?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        if (entity.getUserTeamId() == null) {
          ...
          statement.bindLong(5, entity.getUserTeamId());
        }
        if (entity.getFavouritePlayerTeamId() == null) {
          statement.bindNull(6);
        } else {
          statement.bindLong(6, entity.getFavouritePlayerTeamId());
        }
      }
    };
    this.__updateAdapterOfUser = new EntityDeletionOrUpdateAdapter<User>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `users` SET `id` = ?,`name` = ?,`email` = ?,`passwordHash` = ?,`userTeamId` = ?,`favouritePlayerTeamId` = ? WHERE `id` = ?";
      }
    ...
    return CoroutinesRoom.execute(__db, false, _cancellationSignal, new Callable<User>() {
      ...
      public User call() throws Exception {
        ...
        try {
          ...
          final int _cursorIndexOfFavouritePlayerTeamId = CursorUtil.getColumnIndexOrThrow(_cursor, "favouritePlayerTeamId");
          final User _result;
          if (_cursor.moveToFirst()) {
            ...
            final Long _tmpFavouritePlayerTeamId;
            if (_cursor.isNull(_cursorIndexOfFavouritePlayerTeamId)) {
              _tmpFavouritePlayerTeamId = null;
            } else {
              _tmpFavouritePlayerTeamId = _cursor.getLong(_cursorIndexOfFavouritePlayerTeamId);
            }
            _result = new User(_tmpId,_tmpName,_tmpEmail,_tmpPasswordHash,_tmpUserTeamId,_tmpFavouritePlayerTeamId);
          } else {
            _result = null;
          }
          return _result;
